package com.vit.cameralibs.utils;
...
//    public Point getBestPreviewSize(List<Camera.Size> list, Point size) {
//        int bestW = 0;
//        int bestH = 0;
//
//        float sourceRate = (float)size.x / (float) size.y;
//        Log.d(TAG, "getBestPreviewSize: sourceRate:" + sourceRate);
//
//        float difRate = Integer.MAX_VALUE;
//
//        Collections.sort(list, sizeComparator);
//        for (int i=0; i<list.size(); i++) {
//            Camera.Size s = list.get(i);
//            Log.d(TAG, "getBestPreviewSize: W:" + s.width + "   bestH:" + s.height);
//            float newRate = (float) s.width / (float) s.height;
//            Log.d(TAG, "getBestPreviewSize: newRate:" + newRate);
//            float newDifRate = Math.abs(newRate - sourceRate);
//
//            if (newDifRate < difRate) {
//
//            }
//
////            int newDiff = Math.abs(newW - size.x) + Math.abs(newH - size.y);
////            if (newDiff == 0) {
////                bestW = newW;
////                bestH = newH;
////                break;
...
//        bestW = 480;
//        bestH = 640;
//        Log.d(TAG, "getBestPreviewSize: bestW:" + bestW + "   bestH:" + bestH);
